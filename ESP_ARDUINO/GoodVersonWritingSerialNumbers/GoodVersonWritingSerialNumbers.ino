/////////////////////////////////////////
// USE AN ARDUINO NANO FOR THIS SKETCH //
/////////////////////////////////////////
...
void setup(void)
{
  ...
  for (uint8_t index = 0; index < deviceCount; index++)
  {
    ...
    printAddress(t);
    Serial.print("\t\tID: ");
    unsigned int id = sensors.getUserData(t);
    Serial.println(id);
  }
  
  Serial.println();
  Serial.print("Enter ID for batch: ");
  unsigned int id = 420;                  // Enter Serial Number here in normal decimal value, or hex as 0xABCD
